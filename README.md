...
# Pravakar Das`s Portfolio

This is my personal 3D interactive portfolio website built using **React**, **Three.js**, and **TailwindCSS**.
...
Based on the [Open-Source Project](https://github.com/sanidhyy/3d-portfolio) by Sanidhyy (MIT License)